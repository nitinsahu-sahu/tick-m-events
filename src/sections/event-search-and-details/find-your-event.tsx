    ...
    const applyFilters = useCallback(() => {
        ...
        if (filters.price === 'paid') {
            results = results.filter(event =>
                event.tickets?.some((ticketGroup: any) =>
                    ticketGroup.tickets?.some((ticket: any) =>
        ...
        if (filters.availableTickets) {
            results = results.filter(event =>
                event.tickets?.some((ticketGroup: any) =>
                    ticketGroup.tickets?.some((ticket: any) =>
                        ticket.isLimitedSeat &&
                        parseInt(ticket.totalTickets, 10) > 0
                    )
                )
            );
        }
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <FormControl fullWidth>
                            <InputLabel id="category-label" sx={{ color: 'black', '&.Mui-focused': { color: 'black' }, fontWeight: 500 }}>
                                Category
                            </InputLabel>
                            <Select
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <FormControl fullWidth>
                            ...
                            <InputLabel id="date-label" sx={{ color: 'black', '&.Mui-focused': { color: 'black' }, fontWeight: 500 }}>
                                Date
                            </InputLabel>
                            <Select
                                labelId="date-label"
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <FormControl fullWidth>
                            <InputLabel shrink sx={{ color: 'black', '&.Mui-focused': { color: 'black' }, fontWeight: 500 }}>
                                Location
                            </InputLabel>
                            <TextField
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <FormControl fullWidth>
                            <InputLabel id="price-label" sx={{ color: 'black', '&.Mui-focused': { color: 'black' }, fontWeight: 500 }}>
                                Price
                            </InputLabel>
                            <Select
                                labelId="price-label"
                    ...
                    <Grid item xs={12} sm={6} md={8}>
                        <FormControl fullWidth>
                            <InputLabel id="popularity-label" sx={{ color: 'black', '&.Mui-focused': { color: 'black' }, fontWeight: 500 }}>
                                Sort By
                            </InputLabel>
                            <Select
