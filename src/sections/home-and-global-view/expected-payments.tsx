...
import { availableProjectsTableData, availableProjectsTableHeaders } from "./utills";
    ...
    return (
        <Box mt={4}>
            ...
            >
                ...
                <ReservationsAndContractsTable headers={availableProjectsTableHeaders} data={availableProjectsTableData} type="4" />
                {/* Request Details */}
